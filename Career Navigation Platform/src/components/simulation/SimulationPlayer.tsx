    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/70">Loading internship...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="p-8 mb-6">
          <div className="mb-6">
            ...
            {(step.task || step.description) && (
              <p className="text-white/70 text-lg mb-2">{step.task || step.description}</p>
            )}
              ...
              {isMultiChoiceStep && step.options && !step.kind && (
                <div className="space-y-3">
                  {step.options.map((option: string) => (
                    <div
                      key={option}
                      className="flex items-center gap-3 p-4 border-2 border-white/20 rounded-lg hover:border-green-300 cursor-pointer"
