        ...
        <div className="grid lg:grid-cols-[1.06fr_0.94fr] gap-6 sm:gap-8 items-start mt-6 sm:mt-10">
          ...
          >
            ...
            <div className="relative space-y-5 sm:space-y-7">
              <Badge className="bg-[#7B61FF]/12 text-[#5b4dff] border-[#7B61FF]/20 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 inline-flex w-auto text-xs sm:text-sm">
            ...
            <div className="relative space-y-6 sm:space-y-8">
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-1">
                  <p className="text-xs sm:text-sm uppercase tracking-[0.18em] text-[#0f1b40]/50">Вход</p>
                  <h2 className="text-xl sm:text-2xl font-bold text-[#0f1b40]">Доступ к Naviq</h2>
                  <p className="text-xs sm:text-sm text-[#0f1b40]/60">Продолжи свой путь в несколько кликов.</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-3 text-xs sm:text-sm text-[#0f1b40]/70">
                <div className="flex items-center gap-2">
                  <Brain className="w-4 h-4 text-[#7B61FF] flex-shrink-0" />
