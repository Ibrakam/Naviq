        ...
        <div className="grid lg:grid-cols-[1.06fr_0.94fr] gap-8 items-start mt-10">
          ...
          >
            ...
            <div className="relative space-y-7">
              <Badge className="bg-[#00E5A0]/12 text-[#0EAD7A] border-[#00E5A0]/20 rounded-full px-4 py-2 inline-flex w-auto">
            ...
            <div className="relative space-y-8">
              <div className="flex items-center justify-between gap-3">
                <div className="space-y-1">
                  <p className="text-sm uppercase tracking-[0.18em] text-[#0f1b40]/50">Регистрация</p>
                  <h2 className="text-2xl font-bold text-[#0f1b40]">Создай аккаунт Naviq</h2>
                  <p className="text-sm text-[#0f1b40]/60">Заполни поля — мы настроим маршрут под тебя.</p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-[#0f1b40]">
                    Имя
                  </Label>
