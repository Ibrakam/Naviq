...
export function Signup({ onSignup, onGoogleAuth, onLogin, onBack }: SignupProps) {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-3xl mb-2">Создать аккаунт</h1>
      ...
      <div className="hidden lg:block flex-1 bg-gradient-to-br from-green-400 to-green-600 p-12 text-white">
        <div className="h-full flex flex-col justify-center max-w-lg">
          <h2 className="text-4xl mb-6">Присоединяйся к тысячам студентов</h2>
          <p className="text-xl opacity-90 mb-8">
            Которые уже нашли свой карьерный путь с помощью AI-навигатора Naviq
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>Персональная профориентация</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                ✓
              </div>
              <span>Реальные карьерные симуляции</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                ✓
              </div>
              <span>Сертификаты для резюме</span>
            </div>
          </div>
        </div>
      </div>
