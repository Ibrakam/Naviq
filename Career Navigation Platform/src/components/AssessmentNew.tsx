    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Загрузка теста...</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'Не удалось загрузить вопросы'}</p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Анализ результатов...</h2>
          <p className="text-gray-600">AI обрабатывает ваши ответы</p>
        </motion.div>
      </div>
    );
  }
                ...
                <motion.button
                  ...
                  className={`w-full text-left p-6 rounded-2xl border-2 transition-all duration-300 ${
                    selectedAnswer === answer.id
                      ...
                      : 'border-gray-200 bg-white hover:border-[#d2d7ff] hover:shadow-lg'
                  }`}
                >
